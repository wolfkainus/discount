...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { description: @coupon.description, expiration: @coupon.expiration, photo: @coupon.photo, title: @coupon.title, value: @coupon.value }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { description: @coupon.description, expiration: @coupon.expiration, photo: @coupon.photo, title: @coupon.title, value: @coupon.value }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
